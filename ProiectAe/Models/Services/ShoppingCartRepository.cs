...
namespace ProiectAe.Models.Services
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        public ShoppingCartRepository(FlowerShopDbContext dbContext)
        {
        ...
        public static ShoppingCartRepository GetCart(IServiceProvider services)
        {
            ...
            FlowerShopDbContext context = services.GetService<FlowerShopDbContext>() ?? throw new Exception("Error initializing flowershopdbcontext");
